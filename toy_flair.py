...
class ToyFLAIR(RawGeoFMDataset):
    def __init__(
        self,
        split: str,
        dataset_name: str,
        ...
        self._label_dir = sorted(
            glob(os.path.join(self._base_dir, self.split, "masks", "*.tif"))
        )
    ...
    def __getitem__(self, index):
        ...
        target = tiff.imread(self._label_dir[index]) - 1.
